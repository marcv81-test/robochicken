...
class TestJacobianInverseSolver:
    ...
    def test_limit_input_fix_vector(self):
        ...
        f = lambda x: x
        f_solver = JacobianInverseSolver(function = f, max_input_fix_norm = 1)

        # A norm above the max is altered
        npt.assert_almost_equal([1, 0, 0], f_solver.limit_input_fix_vector([2, 0, 0]))

        # A norm below the max is not altered
        npt.assert_almost_equal([0.5, 0, 0], f_solver.limit_input_fix_vector([0.5, 0, 0]))
    ...
    def test_converge(self):
        ...
        f_solver = JacobianInverseSolver(function = f, max_input_fix_norm = 1000)
